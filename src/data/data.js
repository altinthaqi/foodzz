export const DUMMY_MEALS = [
  {
    id: "m0",
    image:
      "https://images.unsplash.com/photo-1588315029754-2dd089d39a1a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8N3x8cGl6emF8ZW58MHwwfDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60",
    name: "Neapolitan Pizza",
    description: `With just a few ingredients: dough, tomatoes, olive oil, salt and basil -- the Neapolitans created a food that everyone enjoys thoroughly.`,
    price: 22.99,

    prepareTime: "30",
    ingredients: [
      "1 ball Best Homemade Pizza Dough, 1/3 cup Easy Pizza Sauce,",
      "3 ounces fresh mozzarella cheese (or about ¾ cup shredded mozzarella),",
      "Kosher salt, 2 basil leaves,",
  ...
  },
  {
    ...
    name: "Sushi",
    description:
      "Fueled by nothing more complicated than raw fish and rice, but it's how the fish and rice is put together that makes this a global first-date favorite",
    price: 22.99,
  ...
  },
  {
    ...
    name: "Lasagna",
    description:
      "Pasta-layered, tomato-sauce-infused, with a high-quality minced-meaty that will melt in your mouth!",
    price: 16.5,

    image:
      "https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fstatic.onecms.io%2Fwp-content%2Fuploads%2Fsites%2F43%2F2020%2F07%2F11%2Fworlds-best-lasagna.jpeg",
    prepareTime: "30",
    ingredients: [
  ...
  },
  {
    ...
    description:
      "American, raw, meaty grilled BBQ Burger. By mixing in a few ingredients with the beef, you get to eat a delicious, flavorful burger. ",
    price: 12.99,

    image:
      "https://www.foxandbriar.com/wp-content/uploads/2020/05/BBq-Cheese-Burgers-4-of-4.jpg",
    prepareTime: "10",
    ingredients: [
  ...
  },
  {
    ...
    name: "Green Bowl",
    description:
      "Bright and refreshing Green Bowl dressing perks up the grains in this delicious bowl, filled to the brim with all the green veggies.",
    price: 18.99,

    image:
      "https://assets.epicurious.com/photos/58efc4b2bf5d820f40d36f21/1:1/w_1920,c_limit/04122017-buddhabowls-recipe.jpg",
    prepareTime: "45",
    ingredients: [
  ...
  },
  {
    ...
    name: "Croissant",
    description:
      "Flaky pastry smothered in butter, a pile of raspberry jam smeared over the top and a soft, giving bite as you sink in your teeth",
    price: 18.99,
    ...
    ingredients: [
      ...
      "¼ cup/57 grams unsalted butter, cut into 1/2-inch pieces, chilled.",
    ],
    instructions: [
